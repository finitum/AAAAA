<template>
  <button class="newuser" @click="newUser = true">New user</button>
...
.newuser {
  @apply w-full bg-gray-200 appearance-none border-2 border-gray-300 rounded py-1 px-4 text-gray-700 leading-tight;
}
